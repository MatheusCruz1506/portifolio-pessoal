...
import type { UnitStatus, UnitType } from "../src/types/unit";

export const getStatusColor = (status: UnitStatus | null) => {
  switch (status) {
    case "Ativo":
      return {
        classes:
...
export const getTypeIcon = (type: UnitType) => {
...
export const getTypeBadgeClasses = (type: UnitType) => {
  switch (type) {
    case "Hospital":
